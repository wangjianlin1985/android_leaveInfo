...
public class NewsAction extends BaseAction {
    ...
    public String QueryNews() {
        ...
        List<News> newsList = newsDAO.QueryNewsInfo(title, publishDate, currentPage);
        /*计算总的页数和总的记录数*/
    ...
    public String QueryNewsOutputToExcel() { 
        ...
        String[] headers = { "公告编号","标题","公告内容","发布日期"};
        List<String[]> dataset = new ArrayList<String[]>(); 
        for(int i=0;i<newsList.size();i++) {
        	News news = newsList.get(i); 
        	dataset.add(new String[]{news.getNewsId() + "",news.getTitle(),news.getContent(),new SimpleDateFormat("yyyy-MM-dd").format(news.getPublishDate())});
        }
        /*
