...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>标题:</td>
    <td width=70%><input id="news.title" name="news.title" type="text" size="20" /></td>
  </tr>
  ...
  <tr>
    <td width=30%>发布日期:</td>
    <td width=70%><input type="text" readonly id="news.publishDate"  name="news.publishDate" onclick="setDay(this);"/></td>
  </tr>
