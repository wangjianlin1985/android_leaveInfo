...
public class UserInfoService {
	...
	public String AddUserInfo(UserInfo userInfo) {
		...
		params.put("departmentObj", userInfo.getDepartmentObj() + "");
		params.put("mobileNumber", userInfo.getMobileNumber());
		params.put("positionName", userInfo.getPositionName() + "");
	...
	public List<UserInfo> QueryUserInfo(UserInfo queryConditionUserInfo) throws Exception {
		...
		if(queryConditionUserInfo != null) {
			...
			urlString += "&departmentObj=" + queryConditionUserInfo.getDepartmentObj();
			urlString += "&mobileNumber=" + URLEncoder.encode(queryConditionUserInfo.getMobileNumber(), "UTF-8") + "";
			urlString += "&positionName=" + queryConditionUserInfo.getPositionName();
		}
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				userInfo.setDepartmentObj(object.getInt("departmentObj"));
				userInfo.setMobileNumber(object.getString("mobileNumber"));
				userInfo.setPositionName(object.getInt("positionName"));
