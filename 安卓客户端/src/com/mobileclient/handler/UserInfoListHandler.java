	...
	public void characters(char[] ch, int start, int length) throws SAXException {
		...
		if (userInfo != null) { 
            ...
            if ("user_name".equals(tempString)) 
            	...
            	userInfo.setDepartmentObj(new Integer(valueString).intValue());
            else if ("mobileNumber".equals(tempString)) 
            	userInfo.setMobileNumber(valueString); 
            else if ("positionName".equals(tempString)) 
            	userInfo.setPositionName(new Integer(valueString).intValue());
        } 
	}
