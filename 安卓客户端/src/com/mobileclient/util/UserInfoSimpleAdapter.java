...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  holder.tv_mobileNumber = (TextView)convertView.findViewById(R.id.tv_mobileNumber);
	  ...
	  holder.tv_departmentObj.setText("所在部门：" + (new DepartmentService()).GetDepartment(Integer.parseInt(mData.get(position).get("departmentObj").toString())).getDepartmentName());
	  holder.tv_mobileNumber.setText("手机号：" + mData.get(position).get("mobileNumber").toString());
	  holder.tv_positionName.setText("职级：" + (new PositionService()).GetPosition(Integer.parseInt(mData.get(position).get("positionName").toString())).getPositionName());
	  /*返回修改好的view*/
	  return convertView; 
    } 
