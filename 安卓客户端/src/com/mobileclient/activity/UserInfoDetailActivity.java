...
public class UserInfoDetailActivity extends Activity {
	...
	private void initViewData() {
		...
		Department departmentObj = departmentService.GetDepartment(userInfo.getDepartmentObj());
		this.TV_departmentObj.setText(departmentObj.getDepartmentName());
		this.TV_mobileNumber.setText(userInfo.getMobileNumber());
		Position positionName = positionService.GetPosition(userInfo.getPositionName());
		this.TV_positionName.setText(positionName.getPositionName());
	} 
}
