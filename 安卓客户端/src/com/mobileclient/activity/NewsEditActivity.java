...
public class NewsEditActivity extends Activity {
			...
			public void onClick(View v) {
				try {
					...
					if(ET_content.getText().toString().equals("")) {
						Toast.makeText(NewsEditActivity.this, "公告内容输入不能为空!", Toast.LENGTH_LONG).show();
					...
					news.setPublishDate(new Timestamp(publishDate.getTime()));
					/*调用业务逻辑层上传新闻公告信息*/
	...
	private void initViewData() {
		...
		Date publishDate = new Date(news.getPublishDate().getTime());
