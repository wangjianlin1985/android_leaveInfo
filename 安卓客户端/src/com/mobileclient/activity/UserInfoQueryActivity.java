	...
	public void onCreate(Bundle savedInstanceState) {
		...
		spinner_departmentObj.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionUserInfo.setDepartmentObj(departmentList.get(arg2-1).getDepartmentId()); 
				else
					queryConditionUserInfo.setDepartmentObj(0);
			}
			@Override
		...
		positionName_ShowText = new String[positionCount+1];
		positionName_ShowText[0] = "不限制";
		for(int i=1;i<=positionCount;i++) { 
			positionName_ShowText[i] = positionList.get(i-1).getPositionName();
		} 
		// 将可选内容与ArrayAdapter连接起来
		...
		spinner_positionName.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionUserInfo.setPositionName(positionList.get(arg2-1).getPositionId()); 
				else
					queryConditionUserInfo.setPositionName(0);
			}
			@Override
			public void onNothingSelected(AdapterView<?> arg0) {}
		});
		...
		btnQuery.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				try {
					...
					queryConditionUserInfo.setMobileNumber(ET_mobileNumber.getText().toString());
