...
public class PositionAddActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.position_add); 
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("添加职级信息");
			...
			public void onClick(View v) {
				try {
					...
					if(ET_positionName.getText().toString().equals("")) {
						Toast.makeText(PositionAddActivity.this, "职级名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传职级信息信息*/
					PositionAddActivity.this.setTitle("正在上传职级信息信息，稍等...");
					String result = positionService.AddPosition(position);
