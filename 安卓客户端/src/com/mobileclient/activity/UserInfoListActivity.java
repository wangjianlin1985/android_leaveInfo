				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new UserInfoSimpleAdapter(UserInfoListActivity.this, list,
	        					...
	        					new String[] { "user_name","name","sex","birthday","departmentObj","mobileNumber","positionName" },
	        					new int[] { R.id.tv_user_name,R.id.tv_name,R.id.tv_sex,R.id.tv_birthday,R.id.tv_departmentObj,R.id.tv_mobileNumber,R.id.tv_positionName,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < userInfoList.size(); i++) {
				...
				map.put("departmentObj", userInfoList.get(i).getDepartmentObj());
				map.put("mobileNumber", userInfoList.get(i).getMobileNumber());
				map.put("positionName", userInfoList.get(i).getPositionName());
				list.add(map);
			}
		} catch (Exception e) { 
